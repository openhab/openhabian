...
setup_file() {
  ...
  # systemctl mocken, damit Tests in CI nicht fehlschlagen
  systemctl() {
    echo "[MOCK systemctl $*]"
    return 0
  }

  # andere systemabhängige Kommandos ggf. ebenfalls mocken
  # z.B. pnpm oder node wenn nötig:
  pnpm() {
    echo "[MOCK pnpm $*]"
    return 0
  }
...
@test "installation-frontail_install" {
  ...
  # systemctl is-active wird jetzt gemockt
