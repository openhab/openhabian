...
homegear_setup() {
  ...
  if cond_redirect apt-get install --yes wiringpi homegear homegear-homematicbidcos homegear-homematicwired homegear-max homegear-management; then echo "OK"; else echo "FAILED"; return 1; fi
