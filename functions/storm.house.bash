...
setup_wb_config() {
  ...
  sed -e "s|%WBTYPE|${1:-${wallboxtype:-openwb-pro}}|;s|%IP|${2:-${wallboxip}}|;s|%TOKEN|${3:-${evcctoken}}|;s|%CARTYPE1|${4:-${cartype1:-tesla}}|;s|%CARNAME1|${5:-${carname1:-meinEAuto1}}|;s|%VIN1|${6:-${vin1}}|;s|%CARCAPACITY1|${7:-${carcapacity1}}|;s|%CARUSER1|${8:-${caruser1}}|;s|%CARPASS1|${9:-${carpass1}}|;s|%CARTYPE2|${10:-${cartype2:-tesla}}|;s|%CARNAME2|${11:-${carname2:-meinEAuto2}}|;s|%VIN2|${12:-${vin2}}|;s|%CARCAPACITY2|${13:-${carcapacity2}}|;s|%CARUSER2|${14:-${caruser2}}|;s|%CARPASS2|${15:-${carpass2}}|;s|%GRIDCOST|${16:-${gridcost}}|;s|%FEEDINCOMPENSATION|${17:-${feedincompensation}}|" "$temp" | egrep -vi ': NULL$' > "$evccConfig"
  rm -f "${temp}"
