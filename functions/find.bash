...
find3_setup() {
  ...
  echo -n "$(timestamp) [openHABian] Setting up FIND3 user account permisions... "
  if ! cond_redirect adduser "${username:-openhabian}" find3; then echo "FAILED"; return 1; fi
  if cond_redirect adduser openhab find3; then echo "OK"; else echo "FAILED"; return 1; fi
