...
show_main_menu() {
  ...
  if [[ "$choice" == "" ]]; then
    ...
    choosenComponents=$(whiptail --title "Manual/Fresh Setup" --checklist "Choose which system components to install or configure:" 25 122 18 --cancel-button Back --ok-button Execute \
