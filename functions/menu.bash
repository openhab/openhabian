...
show_main_menu() {
  ...
  if [[ "$choice" == "" ]]; then
    ...
    choice2=$(whiptail --title "Welcome to the openHABian Configuration Tool $(get_git_revision)" --menu "Setup Options" 23 118 16 --cancel-button Back --ok-button Execute \
