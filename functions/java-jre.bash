...
java_zulu_fetch() {
  ...
  if ! cond_redirect find "$jdkInstallLocation" -mindepth 1 -name "$(basename "$downloadLink" | sed -e 's/.tar.gz//')" -o -prune -exec rm -rf {} \;; then echo "FAILED (clean directory)"; return 1; fi
